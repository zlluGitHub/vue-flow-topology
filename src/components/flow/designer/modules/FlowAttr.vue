  ...
  <div class="flow-attr">
    <a-tabs size="small" defaultActiveKey="flow-attr" :activeKey="activeKey">
      ...
      <a-tab-pane key="node-attr">
        ...
        <!-- 新增内容 -->
        <template v-else-if="currentSelect.type == 'processor'">
          <div class="attr-active">
            <ul>
        ...
        <template v-else-if="currentSelect.type == 'in'">
          <a-form layout="horizontal">
            <a-form-item
              label="类型"
              :label-col="formItemLayout.labelCol"
        ...
        <template v-else-if="currentSelect.type == 'out'">
          <a-form layout="horizontal">
            <a-form-item
              label="类型"
              :label-col="formItemLayout.labelCol"
